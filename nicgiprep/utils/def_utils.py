...
def vol_resample_fast(
    ref_proxy, flo_proxy, proxyflow=None, mode="linear", device="cpu", return_np=False
):
...
class RescaleTransform(nn.Module):
    ...
    def __init__(
        self, inshape, factor=None, target_size=None, gaussian_filter_flag=False
    ):
        """
        Parameters
        ----------
