...
from nicgiprep.utils.fn_utils import gaussian_antialiasing, one_hot_encoding
...
class LongitudinalSegmentationProcessing(Processing):
    def __init__(self, bids_loader, subject_list=None, pipeline_dir=None, **kwargs):
        ...
        super(LongitudinalSegmentationProcessing, self).__init__(bids_loader=bids_loader, subject_list=subject_list,
                                                                 **kwargs)
...
class LongLabelFusionProcessing(LongitudinalSegmentationProcessing):
