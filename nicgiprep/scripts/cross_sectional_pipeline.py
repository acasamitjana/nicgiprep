...
Example Usage (after `pip install -e .`, with all env vars set):
    nicgiprep-cross \
...
# ── CLI ───────────────────────────────────────────────────────────────────────
def parse_args():
    """Parse the command-line arguments of the cross-sectional pipeline."""
...
def main():
    """Build the BIDS layout and run the cross-sectional pipeline steps."""
    args = parse_args()
